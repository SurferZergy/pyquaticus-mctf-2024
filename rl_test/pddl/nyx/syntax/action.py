...
class Action(HappeningMixin):
    ...
    def __init__(self, name, parameters, preconditions, effects, happening_type="default"):
    ...
    def groundify(self, objects, types):
        ...
        for assignment in itertools.product(*type_map):
            ...
            yield Action(self.name, assignment, preconditions, effects, happening_type=happening_type)
