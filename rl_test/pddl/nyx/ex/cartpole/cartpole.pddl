(define (domain cartpole-initial-bhaskara)
  ...
  (:event set_force
      ...
      :effect (and
      	...
      	(assign (theta_ddot)
      		(/
      			(- (* (gravity) (/ (* (* 4 (* (theta) 57.295779513)) (- 180 (* (theta) 57.295779513))) (- 40500 (* (* (theta) 57.295779513) (- 180 (* (theta) 57.295779513))))) ) (* (+ (/ (* (- 0.0 5.0) (* (* (theta) 57.295779513) (* (theta) 57.295779513)) ) (+ 32400 (* (* (theta) 57.295779513) (* (theta) 57.295779513) )) ) 1.0) (/ (+ (F) (* (* (m_pole) (l_pole)) (* (* (theta_dot) (theta_dot)) (/ (* (* 4 (* (theta) 57.295779513)) (- 180 (* (theta) 57.295779513))) (- 40500 (* (* (theta) 57.295779513) (- 180 (* (theta) 57.295779513))))) ) ) ) (+ (m_cart) (m_pole)) ) ) )
      			(* (l_pole) (- (/ 4.0 3.0) (/ (* (m_pole) (* (+ (/ (* (- 0.0 5.0) (* (* (theta) 57.295779513) (* (theta) 57.295779513)) ) (+ 32400 (* (* (theta) 57.295779513) (* (theta) 57.295779513) )) ) 1.0) (+ (/ (* (- 0.0 5.0) (* (* (theta) 57.295779513) (* (theta) 57.295779513)) ) (+ 32400 (* (* (theta) 57.295779513) (* (theta) 57.295779513) )) ) 1.0) )) (+ (m_cart) (m_pole)) ) ) )
  			)
      	)
      	(assign (x_ddot)
      		(-
      			(/ (+ (F) (* (* (m_pole) (l_pole)) (* (* (theta_dot) (theta_dot)) (/ (* (* 4 (* (theta) 57.295779513)) (- 180 (* (theta) 57.295779513))) (- 40500 (* (* (theta) 57.295779513) (- 180 (* (theta) 57.295779513))))) ) ) ) (+ (m_cart) (m_pole)) )
      			(/ (* (* (m_pole) (l_pole)) (* (theta_ddot) (+ (/ (* (- 0.0 5.0) (* (* (theta) 57.295779513) (* (theta) 57.295779513)) ) (+ 32400 (* (* (theta) 57.295779513) (* (theta) 57.295779513) )) ) 1.0) )) (+ (m_cart) (m_pole)) )
  			)
      	)
      )
  )
